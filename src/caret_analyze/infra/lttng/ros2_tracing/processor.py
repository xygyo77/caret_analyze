...
class Ros2Handler():
    ...
    def _handle_add_cpu_info(
        ...
        # callback_start
        cb_start_callback = get_field(event, 'st_cb')
        cb_start_is_intra_process = get_field(event, 'st_op')
        cb_start_real_sec = get_field(event, 'st_rs')
        cb_start_real_nsec = get_field(event, 'st_rns')
        cb_start_cpu_sec = get_field(event, 'st_cs')
        ...
        cb_end_real_nsec = get_field(event, 'ed_rns')
        cb_end_cpu_sec = get_field(event, 'ed_cs')
        cb_end_cpu_nsec = get_field(event, 'ed_cns')
        cb_end_vctsw = get_field(event, 'ed_ctx')
        cb_end_nvctsw = get_field(event, 'ed_nctx')
